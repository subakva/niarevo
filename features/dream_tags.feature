...
Scenario: Creating a dream with dream tags
...
Scenario: Editing a dream with dream tags
  Given I am logged in as "cucumber"
  ...
  And I should see "Your dream has been saved."
  And I should see "falling" within ".dream-tags"

Scenario: Listing recent dreams by dream tag
  ...
  When I go to the dreams page for the dream tag "fishy"
