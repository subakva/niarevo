...
RSpec.describe 'Dream Lists' do
  it 'viewing all recent dreams' do
    ...
    expect(dream_list).not_to include_dreams(not_recent)
  end

  it 'viewing anonymous dreams' do
    ...
    expect(dream_list).not_to include_dreams(not_anonymous)
  end

  it 'viewing dreams for a user' do
    ...
    expect(dream_list).not_to include_dreams(wrong_user)
  end

  it 'viewing dreams with a tag' do
    ...
    expect(dream_list).not_to include_dreams(not_matching)
  end

  it 'viewing dreams with a dream tag' do
    tagged1       = FactoryBot.create(:dream, dream_tags: ['stump'])
  ...
  it 'viewing dreams with a dreamer tag' do
  ...
  it 'viewing untagged dreams' do
    ...
    expect(dream_list).not_to include_dreams(tagged)
  end

  it 'viewing dreams without dream tags' do
  ...
  it 'viewing dreams without dreamer tags' do
  ...
  it 'viewing dreams by year' do
    ...
    expect(dream_list).not_to include_dreams(previous_year)
  end

  it 'viewing dreams by month' do
    ...
    expect(dream_list).not_to include_dreams(previous_month)
  end

  it 'viewing dreams by day' do
    ...
    expect(dream_list).not_to include_dreams(previous_day)
  end
end
